...
def architecture():
    ...
    s.text(1160, 488, "Optional offline step:", 14, 700, AI[1], "middle")
    s.text(1160, 508, "Gemini can word each", 14, 700, AI[1], "middle")
    s.text(1160, 528, "mismatch reason in plain", 14, 700, AI[1], "middle")
    s.text(1160, 548, "language. It never decides.", 14, 700, AI[1], "middle")
